document.addEventListener("DOMContentLoaded", function () {
    ...
    displayOrderPreview(); // Отображаем предварительный просмотр заказа
    });
    
    // Обработчик события нажатия кнопки "Подтвердить"
    confirmButton.addEventListener("click", function () {
    displayOrderData(); // Выводим данные заказа
    ...
    console.log("Уровень срочности:", urgency);
    console.log("Дедлайн:", deadline);
    console.log("Описание задачи:", description);
    console.log("Согласование:", approval);
    }
    });
